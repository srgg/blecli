...
struct DeviceSettingsServiceImpl {
    ...
    // Descriptors
    using ConfigDesc = typename Blex::descriptors::template UserDescription<config_desc_text>;
    using StateDesc = typename Blex::descriptors::template UserDescription<state_desc_text>;
    using ControlDesc = typename Blex::descriptors::template UserDescription<control_desc_text>;
